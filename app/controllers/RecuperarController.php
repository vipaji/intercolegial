...
Class RecuperarController extends Controller {
    ...
    public function init() {
        ...
        */
        ...
        $this->dados['title_page'] = 'Recuperação de Palavra-passe | Autenticador Online';
        $this->dados['page_context'] = "Recuperação de Palavra-passe | Autenticador Online";
    ...
    public function indexAction() {
        try {
            ...
            $this->view('recuperar/index', $this->dados);
        } catch (Exception $exc) {
